...
if year == '2018':
    if isMC:
        if doSelection:
            branches = ['Bp_ConsBp_0_M', 'Bp_ConsBp_0_status', 'Bp_L0HadronDecision_TOS', 'Bp_L0HadronDecision_TIS', 'Bp_L0MuonDecision_TIS', 'Bp_L0ElectronDecision_TIS', 'Bp_L0PhotonDecision_TIS', 'Bp_Hlt1TrackMVADecision_TOS', 'Bp_Hlt1TwoTrackMVADecision_TOS', 'Bp_Hlt2Topo2BodyDecision_TOS', 'Bp_Hlt2Topo3BodyDecision_TOS', 'Bp_Hlt2Topo4BodyDecision_TOS', 'Bp_ConsBp_0_decayLength', 'Bp_ConsBp_0_tauminus_0_decayLength', 'Bp_ConsBp_0_tauminus_decayLength', 'taup_DIRA_ORIVX', 'taum_DIRA_ORIVX', 'Bp_DIRA_OWNPV', 'taup_ENDVERTEX_X', 'taum_ENDVERTEX_X', 'taup_ENDVERTEX_Y', 'taum_ENDVERTEX_Y', 'taup_ENDVERTEX_Z', 'taum_ENDVERTEX_Z', 'Bp_ConsBp_0_chi2']
        elif variables == 0:
            branches = ['taum_M', 'taum_M12', 'taum_M13', 'taum_M23', 'taum_ENDVERTEX_CHI2', 'Bp_ConsBp_0_tauminus_0_decayLength', 'Bp_ConsBp_0_tauminus_0_decayLengthErr', 'taum_DIRA_ORIVX', 'taum_DIRA_OWNPV', 'taum_pi1_IPCHI2_OWNPV', 'taum_pi2_IPCHI2_OWNPV', 'taum_pi3_IPCHI2_OWNPV', 'Bp_ConsBp_0_tauminus_0_PE', 'Bp_ConsBp_0_tauminus_0_PX', 'Bp_ConsBp_0_tauminus_0_PY', 'Bp_ConsBp_0_tauminus_0_PZ']
        elif variables == 1:
            ...
            branches = ['Bp_ConsBp_0_PX', 'Bp_ConsBp_0_PY[09', 'Bp_ConsBp_0_PZ', 'Bp_ConsBp_0_decayLength', 'Bp_ConsBp_0_decayLengthErr', 'Bp_ETA', 'Bp_M01', 'Bp_M02', 'Bp_M03', 'Bp_M04', 'Bp_M05', 'Bp_M06', 'Bp_M012', 'Bp_M013', 'Bp_M014', 'Bp_M015', 'Bp_M016', 'Bp_M023', 'Bp_M024', 'Bp_M025', 'Bp_M026', 'Bp_M034', 'Bp_M035', 'Bp_M036', 'Bp_M045', 'Bp_M046', 'Bp_M056']
        elif variables == 5:
...
if isMC:
    ...
    with open('/home/felician/B2Ktautau/data_'+year+'_MagUp.txt') as file:
        files_MagUp = file.read().splitlines() 
    with open('/home/felician/B2Ktautau/data_'+year+'_MagDown.txt') as file:
        files_MagDown = file.read().splitlines() 
