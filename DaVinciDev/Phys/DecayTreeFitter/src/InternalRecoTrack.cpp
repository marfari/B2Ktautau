...
namespace DecayTreeFitter {
  ...
  InternalRecoTrack::InternalRecoTrack( const LHCb::Particle& cand, const ParticleBase* mother,
  ...
  ErrCode InternalRecoTrack::updCache( const FitParams& fitparams ) {
    ErrCode rc;
  ...
  ErrCode InternalRecoTrack::projectRecoConstraint( const FitParams& fitparams, Projection& p ) const {
    ErrCode status;
    assert( m_cached );
  ...
  ErrCode InternalRecoTrack::projectConstraint( Constraint::Type type, const FitParams& fitparams,
                                                Projection& p ) const {
    ErrCode status;
    switch ( type ) {
