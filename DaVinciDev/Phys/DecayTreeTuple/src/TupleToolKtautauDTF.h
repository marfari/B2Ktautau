 ...
 * -  Example:
 ...
 from Configurables import TupleToolKtautauDTF
 tuple.B.ToolList +=  [ "TupleToolKtautauDTF/Fit",            # just a refit
 "TupleToolKtautauDTF/MassFit",        # fit with J/psi mass constraint
 "TupleToolKtautauDTF/PVFit" ]         # fit with all constraints I can think of

 tuple.B.addTool(TupleToolKtautauDTF("MassFit"))
 tuple.B.MassFit.constrainToOriginVertex = False
 tuple.B.MassFit.daughtersToConstrain = [ "J/psi(1S)" ]

 tuple.B.addTool(TupleToolKtautauDTF("PVFit"))
 ...
 tuple.B.ToolList +=  ["TupleToolKtautauDTF/SubLambda", "TupleToolKtautauDTF/SubLambdabar" ]
 subDTF = TupleToolKtautauDTF("SubLambda", Verbose=True,
...
struct IDVAlgorithm;
/** @class TupleToolKtautauDTF TupleToolKtautauDTF.h
 *
 * Yasmine Amhis and Matt Needham
 * 30-10-10
 */
class TupleToolKtautauDTF : public TupleToolBase, virtual public IParticleTupleTool {
...
public:
  ...
  TupleToolKtautauDTF( const std::string& type, const std::string& name, const IInterface* parent );

  ~TupleToolKtautauDTF() = default; ///< Destructor
