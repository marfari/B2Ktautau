 ...
 * -  Example:
 ...
 from Configurables import B2KtautauDTF1
 tuple.B.ToolList +=  [ "B2KtautauDTF1/Fit",            # just a refit
 "B2KtautauDTF1/MassFit",        # fit with J/psi mass constraint
 "B2KtautauDTF1/PVFit" ]         # fit with all constraints I can think of

 tuple.B.addTool(B2KtautauDTF1("MassFit"))
 tuple.B.MassFit.constrainToOriginVertex = False
 tuple.B.MassFit.daughtersToConstrain = [ "J/psi(1S)" ]

 tuple.B.addTool(B2KtautauDTF1("PVFit"))
 ...
 tuple.B.ToolList +=  ["B2KtautauDTF1/SubLambda", "B2KtautauDTF1/SubLambdabar" ]
 subDTF = B2KtautauDTF1("SubLambda", Verbose=True,
...
struct IDVAlgorithm;
/** @class B2KtautauDTF1 B2KtautauDTF1.h
 *
 * Yasmine Amhis and Matt Needham
 * 30-10-10
 */
class B2KtautauDTF1 : public TupleToolBase, virtual public IParticleTupleTool
{
...
public:
  ...
  B2KtautauDTF1( const std::string& type,
                            const std::string& name,
                            const IInterface* parent);

  ~B2KtautauDTF1( ) = default; ///< Destructor
