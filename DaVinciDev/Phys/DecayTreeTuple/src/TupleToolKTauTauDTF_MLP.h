 ...
 * -  Example:
 ...
 from Configurables import TupleToolKTauTauDTF_MLP
 tuple.B.ToolList +=  [ "TupleToolKTauTauDTF_MLP/Fit",            # just a refit
 "TupleToolKTauTauDTF_MLP/MassFit",        # fit with J/psi mass constraint
 "TupleToolKTauTauDTF_MLP/PVFit" ]         # fit with all constraints I can think of

 tuple.B.addTool(TupleToolKTauTauDTF_MLP("MassFit"))
 tuple.B.MassFit.constrainToOriginVertex = False
 tuple.B.MassFit.daughtersToConstrain = [ "J/psi(1S)" ]

 tuple.B.addTool(TupleToolKTauTauDTF_MLP("PVFit"))
 ...
 tuple.B.ToolList +=  ["TupleToolKTauTauDTF_MLP/SubLambda", "TupleToolKTauTauDTF_MLP/SubLambdabar" ]
 subDTF = TupleToolKTauTauDTF_MLP("SubLambda", Verbose=True,
...
struct IDVAlgorithm;
/** @class TupleToolKTauTauDTF_MLP TupleToolKTauTauDTF_MLP.h
 *
 * Yasmine Amhis and Matt Needham
 * 30-10-10
 */
class TupleToolKTauTauDTF_MLP : public TupleToolBase, virtual public IParticleTupleTool
{
...
public:
  ...
  TupleToolKTauTauDTF_MLP( const std::string& type,
                            const std::string& name,
                            const IInterface* parent);

  ~TupleToolKTauTauDTF_MLP( ) = default; ///< Destructor
