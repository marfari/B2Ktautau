...
/**@class TupleToolKTauTauDTFSequential_DDK
 ...
 * -  Example:
 ...
 from Configurables import TupleToolKTauTauDTFSequential_DDK
 tuple.B.ToolList +=  [ "TupleToolKTauTauDTFSequential_DDK/Fit",            # just a refit
 "TupleToolKTauTauDTFSequential_DDK/MassFit",        # fit with J/psi mass constraint
 "TupleToolKTauTauDTFSequential_DDK/PVFit" ]         # fit with all constraints I can think of

 tuple.B.addTool(TupleToolKTauTauDTFSequential_DDK("MassFit"))
 tuple.B.MassFit.constrainToOriginVertex = False
 tuple.B.MassFit.daughtersToConstrain = [ "J/psi(1S)" ]

 tuple.B.addTool(TupleToolKTauTauDTFSequential_DDK("PVFit"))
 ...
 tuple.B.ToolList +=  ["TupleToolKTauTauDTFSequential_DDK/SubLambda", "TupleToolKTauTauDTFSequential_DDK/SubLambdabar" ]
 subDTF = TupleToolKTauTauDTFSequential_DDK("SubLambda", Verbose=True,
...
struct IDVAlgorithm;
/** @class TupleToolKTauTauDTFSequential_DDK TupleToolKTauTauDTFSequential_DDK.h
 *
 * Yasmine Amhis and Matt Needham
 * 30-10-10
 */
class TupleToolKTauTauDTFSequential_DDK : public TupleToolBase, virtual public IParticleTupleTool
{
...
public:
  ...
  TupleToolKTauTauDTFSequential_DDK( const std::string& type,
                            const std::string& name,
                            const IInterface* parent);

  ~TupleToolKTauTauDTFSequential_DDK( ) = default; ///< Destructor
...
private:
  ...
  //Added by AV
  StatusCode fillChi2Iter(DecayTreeFitter::Fitter& fitter,
                          std::vector<float> chisq_iters,
                          const std::string& prefix,
                          Tuples::Tuple& tuple ) const;

  //Added by AV
  StatusCode fillEndVtx(const std::string& prefix, 
                        TupleMap& tMap, 
                        Gaudi::XYZPoint vtx) const;
  ...
  Gaudi::XYZVector makeTransformation_vec(Gaudi::XYZVector p_K, Gaudi::XYZPoint refPoint, 
                                          Gaudi::XYZVector theVector, bool invFlag);
  
  Gaudi::XYZPoint makeTransformation_point(Gaudi::XYZVector p_K, Gaudi::XYZPoint refPoint, 
...
private:
  ...
  bool m_fillIterInfo; // Added by AV
