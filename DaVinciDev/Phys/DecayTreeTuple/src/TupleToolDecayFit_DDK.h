...
class TupleToolDecayFit_DDK : public TupleToolBase, virtual public IParticleTupleTool
{
    private:
    ...
    public:
        ...
        TupleToolDecayFit_DDK( const std::string& type,
                           const std::string& name,
                           const IInterface* parent );

        // Destructor
        ~TupleToolDecayFit_DDK() = default;
