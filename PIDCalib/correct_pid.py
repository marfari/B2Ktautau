...
files = [
    ("root://myCerttxt@eoslhcb.cern.ch//eos/lhcb/grid/user/lhcb/user/m/mfaria/2024_07/909023/909023227/DVntuple_MC_Ktautau_2016_MagUp.root", "/panfs/felician/B2Ktautau/workflow/PIDCalib/sim10c_2016_pidcorr", "MagUp_2016")
]
...
config = {
  'Kp' :    {
            "ProbNNk"    : ("ProbNNk",  "K_Dstar2Dpi", "MC15TuneV1_ProbNNK", kernels),
            "ProbNNpi"   : ("ProbNNpi", "K_Dstar2Dpi", "MC15TuneV1_ProbNNpi", kernels)
           },
  'taup_pi1' :    {
