...
xu_symbols = sp.symbols('BVx BVy BVz pBx pBy pBz mB_squared ptau2x ptau2y ptau2z Etau2 pnu2x pnu2y pnu2z Enu2')
lb_symbols = sp.symbols('lb0 lb1 lb2 lb3 lb4 lb5 lb6 lb7 lb8 lb9 lb10 lb11 lb12 lb13 lb14 lb15')
x_symbols = sp.symbols('PVx PVy PVz DV1x DV1y DV1z p3pi1x p3pi1y p3pi1z E3pi1 DV2x DV2y DV2z p3pi2x p3pi2y p3pi2z E3pi2 RPx RPy pKx pKy pKz BVx BVy BVz pBx pBy pBz mB_squared ptau2x ptau2y ptau2z Etau2 pnu2x pnu2y pnu2z Enu2 lb0 lb1 lb2 lb3 lb4 lb5 lb6 lb7 lb8 lb9 lb10 lb11 lb12 lb13 lb14 lb15')
...
def lagrangian(params):
    ...
    g.append( pBx - p3pi1x - ptau2x - pKx ) 
    g.append( pBy - p3pi1y - ptau2y - pKy ) 
    g.append( pBz - p3pi1z - ptau2z - pKz ) 
    g.append(EB(mB_squared,pBx,pBy,pBz) - E3pi1 - Etau2 - EK(pKx,pKy,pKz))
...
def main(argv):
    ...
    for evt in range(num_entries):
        ...
        # plt.plot(np.arange(len(sum_iter)), sum_iter, 'o', label=name[i])
        # chi2_iter = []
        # mass_iter = []
        # sum_iter = []
