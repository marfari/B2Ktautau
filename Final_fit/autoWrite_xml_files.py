...
def main(argv):
    ...
    c_bdt1_bdt2 = numerator/bdt_independent_constant
    
    if(c_bdt1_bdt2.nominal_value == 0):
        upward_variation = 0
        downward_variation = 0
    else:
        upward_variation = 1+(c_bdt1_bdt2.std_dev/c_bdt1_bdt2.nominal_value)
        downward_variation = 1-(c_bdt1_bdt2.std_dev/c_bdt1_bdt2.nominal_value)

    string1 = '''
<!DOCTYPE Channel  SYSTEM 'HistFactorySchema.dtd'>

<Channel Name="channel1" InputFile="/panfs/felician/B2Ktautau/workflow/generate_fit_templates/{5}/fit_templates_bdt1_{0}_bdt2_{1}_seed_{2}.root" >
    ...
    <Sample Name="Signal" HistoPath="Signal" HistoName="nominal">
        ...
        <NormFactor Name="c_bdt1_bdt2" Val=\"{6}\" Low="0" High="1000000000." />
        <OverallSys Name="c_bdt1_bdt2_syst" High=\"{7}\" Low=\"{8}\" ConstraintType="Gaussian"/>
    ...
    '''.format( bdt1, bdt2, random_seed, N_bkg, 10*N_bkg, folder_name, c_bdt1_bdt2.nominal_value, upward_variation, downward_variation )
