...
def main(argv):
    ...
    bins_1 = [h_data_1.GetBinLowEdge(i+1) for i in range(nbins_1+1)]
    bins_1 = array.array('d', bins_1)

    bins_2 = [h_data_2.GetBinLowEdge(i+1) for i in range(nbins_2+1)]
    bins_2 = array.array('d', bins_2)

    bins_3 = [h_data_3.GetBinLowEdge(i+1) for i in range(nbins_3+1)]
    bins_3 = array.array('d', bins_3)
    ...
    h_sig = ROOT.TH1D("h_sig", "h_sig", nbins, bins)
    h_sig_1 = ROOT.TH1D("h_sig_1", "h_sig_1", nbins_1, bins_1)
    h_sig_2 = ROOT.TH1D("h_sig_2", "h_sig_2", nbins_2, bins_2)
    h_sig_3 = ROOT.TH1D("h_sig_3", "h_sig_3", nbins_3, bins_3)

    h_bkg = ROOT.TH1D("h_bkg", "h_bkg", nbins, bins)
    h_bkg_1 = ROOT.TH1D("h_bkg_1", "h_bkg_1", nbins_1, bins_1)
    h_bkg_2 = ROOT.TH1D("h_bkg_2", "h_bkg_2", nbins_2, bins_2)
    h_bkg_3 = ROOT.TH1D("h_bkg_3", "h_bkg_3", nbins_3, bins_3)

    if((bdt1 >= 0.9) and (bdt2 >= 0.9)):
        t_bkg.Draw("df_Bp_M >> h_bkg", "(BDT1 > {0}) && (BDT2 > {1})".format(0.9,0.9))
        t_bkg.Draw("df_Bp_M >> h_bkg_1", "(BDT1 > {0}) && (BDT2 > {1}) && (df_Bp_MERR >= 0) && (df_Bp_MERR <= 100)".format(0.9,0.9))
        t_bkg.Draw("df_Bp_M >> h_bkg_2", "(BDT1 > {0}) && (BDT2 > {1}) && (df_Bp_MERR > 100) && (df_Bp_MERR <= 250)".format(0.9,0.9))
        t_bkg.Draw("df_Bp_M >> h_bkg_3", "(BDT1 > {0}) && (BDT2 > {1}) && (df_Bp_MERR > 250)".format(0.9,0.9))

        t_sig.Draw("df_Bp_M >> h_sig", "(BDT1 > {0}) && (BDT2 > {1})".format(0.9,0.9))
        t_sig.Draw("df_Bp_M >> h_sig_1", "(BDT1 > {0}) && (BDT2 > {1}) && (df_Bp_MERR >= 0) && (df_Bp_MERR <= 100)".format(0.9,0.9))
        t_sig.Draw("df_Bp_M >> h_sig_2", "(BDT1 > {0}) && (BDT2 > {1}) && (df_Bp_MERR > 100) && (df_Bp_MERR <= 250)".format(0.9,0.9))
        t_sig.Draw("df_Bp_M >> h_sig_3", "(BDT1 > {0}) && (BDT2 > {1}) && (df_Bp_MERR > 250)".format(0.9,0.9))
    else:
        t_bkg.Draw("df_Bp_M >> h_bkg", "(BDT1 > {0}) && (BDT2 > {1})".format(bdt1,bdt2))
        t_bkg.Draw("df_Bp_M >> h_bkg_1", "(BDT1 > {0}) && (BDT2 > {1}) && (df_Bp_MERR >= 0) && (df_Bp_MERR <= 100)".format(bdt1,bdt2))
        t_bkg.Draw("df_Bp_M >> h_bkg_2", "(BDT1 > {0}) && (BDT2 > {1}) && (df_Bp_MERR > 100) && (df_Bp_MERR <= 250)".format(bdt1,bdt2))
        t_bkg.Draw("df_Bp_M >> h_bkg_3", "(BDT1 > {0}) && (BDT2 > {1}) && (df_Bp_MERR > 250)".format(bdt1,bdt2))

        t_sig.Draw("df_Bp_M >> h_sig", "(BDT1 > {0}) && (BDT2 > {1})".format(bdt1,bdt2))
        t_sig.Draw("df_Bp_M >> h_sig_1", "(BDT1 > {0}) && (BDT2 > {1}) && (df_Bp_MERR >= 0) && (df_Bp_MERR <= 100)".format(bdt1,bdt2))
        t_sig.Draw("df_Bp_M >> h_sig_2", "(BDT1 > {0}) && (BDT2 > {1}) && (df_Bp_MERR > 100) && (df_Bp_MERR <= 250)".format(bdt1,bdt2))
        t_sig.Draw("df_Bp_M >> h_sig_3", "(BDT1 > {0}) && (BDT2 > {1}) && (df_Bp_MERR > 250)".format(bdt1,bdt2))
    ...
    if((h_sig_1.Integral() != 0) and (h_bkg_1.Integral() != 0)):
        h_sig_1.Scale(1/h_sig_1.Integral())
        h_bkg_1.Scale(1/h_bkg_1.Integral())

    if((h_sig_2.Integral() != 0) and (h_bkg_2.Integral() != 0)):
        h_sig_2.Scale(1/h_sig_2.Integral())
        h_bkg_2.Scale(1/h_bkg_2.Integral())

    if((h_sig_3.Integral() != 0) and (h_bkg_3.Integral() != 0)):
        h_sig_3.Scale(1/h_sig_3.Integral())
        h_bkg_3.Scale(1/h_bkg_3.Integral())

    # Signal + background uncertainties (error)
    h_sig_err = ROOT.TH1D("h_sig_err", "h_sig_err", nbins, bins)
    h_sig_err_1 = ROOT.TH1D("h_sig_err_1", "h_sig_err_1", nbins_1, bins_1)
    h_sig_err_2 = ROOT.TH1D("h_sig_err_2", "h_sig_err_2", nbins_2, bins_2)
    h_sig_err_3 = ROOT.TH1D("h_sig_err_3", "h_sig_err_3", nbins_3, bins_3)

    h_bkg_err = ROOT.TH1D("h_bkg_err", "h_bkg_err", nbins, bins)
    h_bkg_err_1 = ROOT.TH1D("h_bkg_err_1", "h_bkg_err_1", nbins_1, bins_1)
    h_bkg_err_2 = ROOT.TH1D("h_bkg_err_2", "h_bkg_err_2", nbins_2, bins_2)
    h_bkg_err_3 = ROOT.TH1D("h_bkg_err_3", "h_bkg_err_3", nbins_3, bins_3)
    ...
    for i in range(nbins):
        ...
        print("SIGNAL : ", h_sig_err.GetBinContent(i+1), " | BACKGROUND : ", h_bkg_err.GetBinContent(i+1))

    for i in range(nbins_1):
        # if( h_sig_1.GetBinContent(i+1) == 0 ):
        #     h_sig_1.SetBinError(i+1, 10**(-6))
        # if( h_bkg_1.GetBinContent(i+1) == 0 ):
        #     h_bkg_1.SetBinError(i+1, 10**(-6))

        # h_sig_err_1.Fill(h_sig_1.GetBinCenter(i+1), h_sig_1.GetBinError(i+1)) # staterror (absolute)
        if(h_sig_1.GetBinContent(i+1) == 0):
            h_sig_err_1.Fill(h_sig_1.GetBinCenter(i+1), 0.0 ) # shapesys (relative)
        else:
            if(h_sig_1.GetBinError(i+1)/h_sig_1.GetBinContent(i+1) < 0.05):
                h_sig_err_1.Fill(h_sig_1.GetBinCenter(i+1), 0.0 ) # shapesys (relative)
            else:
                h_sig_err_1.Fill(h_sig_1.GetBinCenter(i+1), h_sig_1.GetBinError(i+1)/h_sig_1.GetBinContent(i+1)) # shapesys (relative)
        h_sig_err_1.SetBinError(i+1, 0)

        # h_bkg_err_1.Fill(h_bkg_1.GetBinCenter(i+1), h_bkg_1.GetBinError(i+1)) # staterror (absolute)
        if(h_bkg_1.GetBinContent(i+1) == 0):
            h_bkg_err_1.Fill(h_bkg_1.GetBinCenter(i+1), 0.0) # shapesys (relative)
        else:
            if(h_bkg_1.GetBinError(i+1)/h_bkg_1.GetBinContent(i+1) < 0.05):
                h_bkg_err_1.Fill(h_bkg_1.GetBinCenter(i+1), 0.0) # shapesys (relative)
            else:
                h_bkg_err_1.Fill(h_bkg_1.GetBinCenter(i+1), h_bkg_1.GetBinError(i+1)/h_bkg_1.GetBinContent(i+1)) # shapesys (relative)
        h_bkg_err_1.SetBinError(i+1, 0)    

    for i in range(nbins_2):
        # if( h_sig_2.GetBinContent(i+1) == 0 ):
        #     h_sig_2.SetBinError(i+1, 10**(-6))
        # if( h_bkg_2.GetBinContent(i+1) == 0 ):
        #     h_bkg_2.SetBinError(i+1, 10**(-6))

        # h_sig_err_2.Fill(h_sig_2.GetBinCenter(i+1), h_sig_2.GetBinError(i+1)) # staterror (absolute)
        if(h_sig_2.GetBinContent(i+1) == 0):
            h_sig_err_2.Fill(h_sig_2.GetBinCenter(i+1), 0.0 ) # shapesys (relative)
        else:
            if(h_sig_2.GetBinError(i+1)/h_sig_2.GetBinContent(i+1) < 0.05):
                h_sig_err_2.Fill(h_sig_2.GetBinCenter(i+1), 0.0 ) # shapesys (relative)
            else:
                h_sig_err_2.Fill(h_sig_2.GetBinCenter(i+1), h_sig_2.GetBinError(i+1)/h_sig_2.GetBinContent(i+1)) # shapesys (relative)
        h_sig_err_2.SetBinError(i+1, 0)

        # h_bkg_err_2.Fill(h_bkg_2.GetBinCenter(i+1), h_bkg_2.GetBinError(i+1)) # staterror (absolute)
        if(h_bkg_2.GetBinContent(i+1) == 0):
            h_bkg_err_2.Fill(h_bkg_2.GetBinCenter(i+1), 0.0) # shapesys (relative)
        else:
            if(h_bkg_2.GetBinError(i+1)/h_bkg_2.GetBinContent(i+1) < 0.05):
                h_bkg_err_2.Fill(h_bkg_2.GetBinCenter(i+1), 0.0) # shapesys (relative)
            else:
                h_bkg_err_2.Fill(h_bkg_2.GetBinCenter(i+1), h_bkg_2.GetBinError(i+1)/h_bkg_2.GetBinContent(i+1)) # shapesys (relative)
        h_bkg_err_2.SetBinError(i+1, 0)    

    for i in range(nbins_3):
        # if( h_sig_3.GetBinContent(i+1) == 0 ):
        #     h_sig_3.SetBinError(i+1, 10**(-6))
        # if( h_bkg_3.GetBinContent(i+1) == 0 ):
        #     h_bkg_3.SetBinError(i+1, 10**(-6))

        # h_sig_err_3.Fill(h_sig_3.GetBinCenter(i+1), h_sig_3.GetBinError(i+1)) # staterror (absolute)
        if(h_sig_3.GetBinContent(i+1) == 0):
            h_sig_err_3.Fill(h_sig_3.GetBinCenter(i+1), 0.0 ) # shapesys (relative)
        else:
            if(h_sig_3.GetBinError(i+1)/h_sig_3.GetBinContent(i+1) < 0.05):
                h_sig_err_3.Fill(h_sig_3.GetBinCenter(i+1), 0.0 ) # shapesys (relative)
            else:
                h_sig_err_3.Fill(h_sig_3.GetBinCenter(i+1), h_sig_3.GetBinError(i+1)/h_sig_3.GetBinContent(i+1)) # shapesys (relative)
        h_sig_err_3.SetBinError(i+1, 0)

        # h_bkg_err_3.Fill(h_bkg_3.GetBinCenter(i+1), h_bkg_3.GetBinError(i+1)) # staterror (absolute)
        if(h_bkg_3.GetBinContent(i+1) == 0):
            h_bkg_err_3.Fill(h_bkg_3.GetBinCenter(i+1), 0.0) # shapesys (relative)
        else:
            if(h_bkg_3.GetBinError(i+1)/h_bkg_3.GetBinContent(i+1) < 0.05):
                h_bkg_err_3.Fill(h_bkg_3.GetBinCenter(i+1), 0.0) # shapesys (relative)
            else:
                h_bkg_err_3.Fill(h_bkg_3.GetBinCenter(i+1), h_bkg_3.GetBinError(i+1)/h_bkg_3.GetBinContent(i+1)) # shapesys (relative)
        h_bkg_err_3.SetBinError(i+1, 0)    
    ...
    fout_1 = ROOT.TFile("/panfs/felician/B2Ktautau/workflow/generate_fit_templates/{3}/fit_templates_bdt1_{0}_bdt2_{1}_seed_{2}_ch1.root".format(bdt1, bdt2, random_seed, folder_name), "RECREATE")
    fout_1.mkdir("Data")
    fout_1.mkdir("Signal")
    fout_1.mkdir("Background")

    fout_1.cd("Data")
    h_data_1.SetTitle("data")
    h_data_1.SetName("data")
    h_data_1.Write()

    fout_1.cd("Signal")
    h_sig_1.SetName("nominal")
    h_sig_1.SetTitle("nominal")
    h_sig_err_1.SetName("error")
    h_sig_err_1.SetTitle("error")
    h_sig_1.Write()
    h_sig_err_1.Write()

    fout_1.cd("Background")
    h_bkg_1.SetName("nominal")
    h_bkg_1.SetTitle("nominal")
    h_bkg_err_1.SetName("error")
    h_bkg_err_1.SetTitle("error")
    h_bkg_1.Write()
    h_bkg_err_1.Write()
    ...
    fout_2 = ROOT.TFile("/panfs/felician/B2Ktautau/workflow/generate_fit_templates/{3}/fit_templates_bdt1_{0}_bdt2_{1}_seed_{2}_ch2.root".format(bdt1, bdt2, random_seed, folder_name), "RECREATE")
    fout_2.mkdir("Data")
    fout_2.mkdir("Signal")
    fout_2.mkdir("Background")

    fout_2.cd("Data")
    h_data_2.SetTitle("data")
    h_data_2.SetName("data")
    h_data_2.Write()

    fout_2.cd("Signal")
    h_sig_2.SetName("nominal")
    h_sig_2.SetTitle("nominal")
    h_sig_err_2.SetName("error")
    h_sig_err_2.SetTitle("error")
    h_sig_2.Write()
    h_sig_err_2.Write()

    fout_2.cd("Background")
    h_bkg_2.SetName("nominal")
    h_bkg_2.SetTitle("nominal")
    h_bkg_err_2.SetName("error")
    h_bkg_err_2.SetTitle("error")
    h_bkg_2.Write()
    h_bkg_err_2.Write()
    ...
    fout_3 = ROOT.TFile("/panfs/felician/B2Ktautau/workflow/generate_fit_templates/{3}/fit_templates_bdt1_{0}_bdt2_{1}_seed_{2}_ch3.root".format(bdt1, bdt2, random_seed, folder_name), "RECREATE")
    fout_3.mkdir("Data")
    fout_3.mkdir("Signal")
    fout_3.mkdir("Background")

    fout_3.cd("Data")
    h_data_3.SetTitle("data")
    h_data_3.SetName("data")
    h_data_3.Write()

    fout_3.cd("Signal")
    h_sig_3.SetName("nominal")
    h_sig_3.SetTitle("nominal")
    h_sig_err_3.SetName("error")
    h_sig_err_3.SetTitle("error")
    h_sig_3.Write()
    h_sig_err_3.Write()

    fout_3.cd("Background")
    h_bkg_3.SetName("nominal")
    h_bkg_3.SetTitle("nominal")
    h_bkg_err_3.SetName("error")
    h_bkg_err_3.SetTitle("error")
    h_bkg_3.Write()
    h_bkg_err_3.Write()
