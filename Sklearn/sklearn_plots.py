...
def main(argv):
    ...
    cut_Ktautau = "(df_status == 0) && (df_Bp_M > 4000) && (df_Bp_M < 8000) && ( TMath::Min(TMath::Log10(1 - TMath::Abs(taup_DIRA_ORIVX)) * TMath::Sign(1.0, taup_DIRA_ORIVX), TMath::Log10(1 - TMath::Abs(taum_DIRA_ORIVX)) * TMath::Sign(1.0, taum_DIRA_ORIVX)) < -1 )"
    ...
    cut_cocktail_mc = "(df_status == 0) && (df_Bp_M > 4000) && (df_Bp_M < 8000) && (taup_BKGCAT <= 60) && (taum_BKGCAT <= 60) && (Bp_BKGCAT <= 60) & ( TMath::Min(TMath::Log10(1 - TMath::Abs(taup_DIRA_ORIVX)) * TMath::Sign(1.0, taup_DIRA_ORIVX), TMath::Log10(1 - TMath::Abs(taum_DIRA_ORIVX)) * TMath::Sign(1.0, taum_DIRA_ORIVX)) < -1 )"
    ...
    # sklearn
    fc2_rs_data_2016 = ROOT.TFileCollection("fc2_rs_data_2016", "fc2_rs_data_2016", f"/panfs/felician/B2Ktautau/workflow/sklearn_response/2016/Species_2/bdt_output.txt", 100)
    fc2_rs_data_2017 = ROOT.TFileCollection("fc2_rs_data_2017", "fc2_rs_data_2017", f"/panfs/felician/B2Ktautau/workflow/sklearn_response/2017/Species_2/bdt_output.txt", 100)
    fc2_rs_data_2018 = ROOT.TFileCollection("fc2_rs_data_2018", "fc2_rs_data_2018", f"/panfs/felician/B2Ktautau/workflow/sklearn_response/2018/Species_2/bdt_output.txt", 100)

    fc2_ws_data_2016 = ROOT.TFileCollection("fc2_ws_data_2016", "fc2_ws_data_2016", f"/panfs/felician/B2Ktautau/workflow/sklearn_response/2016/Species_3/bdt_output.txt", 100)
    fc2_ws_data_2017 = ROOT.TFileCollection("fc2_ws_data_2017", "fc2_ws_data_2017", f"/panfs/felician/B2Ktautau/workflow/sklearn_response/2017/Species_3/bdt_output.txt", 100)
    fc2_ws_data_2018 = ROOT.TFileCollection("fc2_ws_data_2018", "fc2_ws_data_2018", f"/panfs/felician/B2Ktautau/workflow/sklearn_response/2018/Species_3/bdt_output.txt", 100)
    ...
    # sklearn
    fc2_norm_mc_no_rect_cuts_2016 = ROOT.TFileCollection("fc2_norm_mc_no_rect_cuts_2016", "fc2_norm_mc_no_rect_cuts_2016", f"/panfs/felician/B2Ktautau/workflow/sklearn_response/2016/Species_71/bdt_output.txt")
    fc2_norm_mc_no_rect_cuts_2017 = ROOT.TFileCollection("fc2_norm_mc_no_rect_cuts_2017", "fc2_norm_mc_no_rect_cuts_2017", f"/panfs/felician/B2Ktautau/workflow/sklearn_response/2017/Species_71/bdt_output.txt")
    fc2_norm_mc_no_rect_cuts_2018 = ROOT.TFileCollection("fc2_norm_mc_no_rect_cuts_2018", "fc2_norm_mc_no_rect_cuts_2018", f"/panfs/felician/B2Ktautau/workflow/sklearn_response/2018/Species_71/bdt_output.txt")
    ...
    # sklearn
    fc2_norm_data_no_rect_cuts_2016 = ROOT.TFileCollection("fc2_norm_data_no_rect_cuts_2016", "fc2_norm_data_no_rect_cuts_2016", f"/panfs/felician/B2Ktautau/workflow/sklearn_response/2016/Species_81/bdt_output.txt", 500)
    fc2_norm_data_no_rect_cuts_2017 = ROOT.TFileCollection("fc2_norm_data_no_rect_cuts_2017", "fc2_norm_data_no_rect_cuts_2017", f"/panfs/felician/B2Ktautau/workflow/sklearn_response/2017/Species_81/bdt_output.txt", 500)
    fc2_norm_data_no_rect_cuts_2018 = ROOT.TFileCollection("fc2_norm_data_no_rect_cuts_2018", "fc2_norm_data_no_rect_cuts_2018", f"/panfs/felician/B2Ktautau/workflow/sklearn_response/2018/Species_81/bdt_output.txt", 500)
    ...
    for i in range(N):
        ...
        h_mass_bdt1_corr_ktautau_mc = ROOT.TH1D(f"h_mass_bdt1_corr_ktautau_mc_{i}", f"h_mass_bdt1_corr_ktautau_mc_{i}", 100, 4000, 8000)
        h_mass_bdt1_corr_cocktail_mc = ROOT.TH1D(f"h_mass_bdt1_corr_cocktail_mc_{i}", f"h_mass_bdt1_corr_cocktail_mc_{i}", 100, 4000, 8000)
        h_mass_bdt1_corr_rs_data = ROOT.TH1D(f"h_mass_bdt1_corr_rs_data_{i}", f"h_mass_bdt1_corr_rs_data_{i}", 100, 4000, 8000)
        h_mass_bdt1_corr_ws_data = ROOT.TH1D(f"h_mass_bdt1_corr_ws_data_{i}", f"h_mass_bdt1_corr_ws_data_{i}", 100, 4000, 8000)

        h_mass_bdt2_corr_ktautau_mc = ROOT.TH1D(f"h_mass_bdt2_corr_ktautau_mc_{i}", f"h_mass_bdt2_corr_ktautau_mc_{i}", 100, 4000, 8000)
        h_mass_bdt2_corr_cocktail_mc = ROOT.TH1D(f"h_mass_bdt2_corr_cocktail_mc_{i}", f"h_mass_bdt2_corr_cocktail_mc_{i}", 100, 4000, 8000)
        h_mass_bdt2_corr_rs_data = ROOT.TH1D(f"h_mass_bdt2_corr_rs_data_{i}", f"h_mass_bdt2_corr_rs_data_{i}", 100, 4000, 8000)
        h_mass_bdt2_corr_ws_data = ROOT.TH1D(f"h_mass_bdt2_corr_ws_data_{i}", f"h_mass_bdt2_corr_ws_data_{i}", 100, 4000, 8000)
        ...
        t_rs_data_2016.Draw(f"df_Bp_M >> h_mass_corr_rs_data_{i}", f"(BDT1 > {bdt_cuts[i]}) && (BDT2 > {bdt_cuts[i]}) && ((df_Bp_M < 4800) || (df_Bp_M > 6000))")
        t_ws_data_2016.Draw(f"df_Bp_M >> h_mass_corr_ws_data_{i}", f"(BDT1 > {bdt_cuts[i]}) && (BDT2 > {bdt_cuts[i]})")

        t_BuKtautau_mc_2016.Draw(f"df_Bp_M >> h_mass_bdt1_corr_ktautau_mc_{i}", f"(BDT1 > {bdt_cuts[i]})")
        t_cocktail_mc.Draw(f"df_Bp_M >> h_mass_bdt1_corr_cocktail_mc_{i}", f"(BDT1 > {bdt_cuts[i]})")
        t_rs_data_2016.Draw(f"df_Bp_M >> h_mass_bdt1_corr_rs_data_{i}", f"(BDT1 > {bdt_cuts[i]}) && ((df_Bp_M < 4800) || (df_Bp_M > 6000))")
        t_ws_data_2016.Draw(f"df_Bp_M >> h_mass_bdt1_corr_ws_data_{i}", f"(BDT1 > {bdt_cuts[i]}) && (BDT2 > {bdt_cuts[i]})")

        t_BuKtautau_mc_2016.Draw(f"df_Bp_M >> h_mass_bdt2_corr_ktautau_mc_{i}", f"(BDT2 > {bdt_cuts[i]})")
        t_cocktail_mc.Draw(f"df_Bp_M >> h_mass_bdt2_corr_cocktail_mc_{i}", f"(BDT2 > {bdt_cuts[i]})")
        t_rs_data_2016.Draw(f"df_Bp_M >> h_mass_bdt2_corr_rs_data_{i}", f"(BDT2 > {bdt_cuts[i]}) && ((df_Bp_M < 4800) || (df_Bp_M > 6000))")
        t_ws_data_2016.Draw(f"df_Bp_M >> h_mass_bdt2_corr_ws_data_{i}", f"(BDT2 > {bdt_cuts[i]}) && (BDT2 > {bdt_cuts[i]})")
    ...
    for i in range(N):
        ...
        leg11.AddEntry(histos_ktautau_mc[j], f"(BDT_{{phys}},BDT_{{comb}}) > ({bdt_cuts[j]},{bdt_cuts[j]})", "fp")
        if(i == 0):
    ...
    for i in range(N):
        ...
        histos_bdt1_ktautau_mc[j].GetYaxis().SetTitle("Normalized entries / (40 MeV)")
        histos_bdt1_ktautau_mc[j].SetTitle("Ktautau MC: B mass vs physics BDT")
        leg11_bdt1.AddEntry(histos_bdt1_ktautau_mc[j], f"BDT_{{phys}} > {bdt_cuts[j]})", "fp")
        if(i == 0):
    ...
    for i in range(N):
        ...
        histos_bdt2_ktautau_mc[j].GetYaxis().SetTitle("Normalized entries / (40 MeV)")
        histos_bdt2_ktautau_mc[j].SetTitle("Ktautau MC: B mass vs combinatorial BDT")
        leg11_bdt2.AddEntry(histos_bdt2_ktautau_mc[j], f"BDT_{{comb}} > {bdt_cuts[j]})", "fp")
        if(i == 0):
    ...
    for i in range(N):
        ...
        leg12.AddEntry(histos_cocktail_mc[j], f"(BDT_{{phys}},BDT_{{comb}}) > ({bdt_cuts[j]},{bdt_cuts[j]})", "fp")
        if(i == 0):
    ...
    for i in range(N):
        ...
        histos_bdt1_cocktail_mc[j].GetYaxis().SetTitle("Normalized entries / (40 MeV)")
        histos_bdt1_cocktail_mc[j].SetTitle("Cocktail MCs: B mass vs physics BDT")
        leg12_bdt1.AddEntry(histos_bdt1_cocktail_mc[j], f"BDT_{{phys}} > {bdt_cuts[j]}", "fp")
        if(i == 0):
    ...
    for i in range(N):
        ...
        histos_bdt2_cocktail_mc[j].GetYaxis().SetTitle("Normalized entries / (40 MeV)")
        histos_bdt2_cocktail_mc[j].SetTitle("Cocktail MCs: B mass vs combinatorial BDT")
        leg12_bdt2.AddEntry(histos_bdt2_cocktail_mc[j], f"BDT_{{comb}} > {bdt_cuts[j]}", "fp")
        if(i == 0):
    ...
    for i in range(N):
        ...
        histos_rs_data[i].GetYaxis().SetTitle("Normalized entries / (40 MeV)")
        histos_rs_data[i].SetTitle("RS data: B mass vs BDT cuts")
        leg13.AddEntry(histos_rs_data[i], f"(BDT_{{phys}},BDT_{{comb}}) > ({bdt_cuts[i]},{bdt_cuts[i]})", "fp")
        if(i == 0):
    ...
    for i in range(N):
        ...
        histos_bdt1_rs_data[i].GetYaxis().SetTitle("Normalized entries / (40 MeV)")
        histos_bdt1_rs_data[i].SetTitle("RS data: B mass vs physics BDT")
        leg13_bdt1.AddEntry(histos_bdt1_rs_data[i], f"BDT_{{phys}} > {bdt_cuts[i]}", "fp")
        if(i == 0):
    ...
    for i in range(N):
        histos_bdt2_rs_data[i].GetXaxis().SetTitle("m_{B} (MeV)")
        histos_bdt2_rs_data[i].GetYaxis().SetTitle("Normalized entries / (40 MeV)")
        histos_bdt2_rs_data[i].SetTitle("RS data: B mass vs combinatorial BDT")
        leg13_bdt2.AddEntry(histos_bdt2_rs_data[i], f"BDT_{{comb}} > {bdt_cuts[i]}", "fp")
        if(i == 0):
            histos_bdt2_rs_data[i].DrawNormalized()
        else:
            histos_bdt2_rs_data[i].DrawNormalized("same")
    ...
    for i in range(N):
        ...
        histos_ws_data[i].GetYaxis().SetTitle("Normalized entries / (40 MeV)")
        histos_ws_data[i].SetTitle("WS data: B mass vs BDT cuts")
        leg14.AddEntry(histos_ws_data[i], f"(BDT_{{phys}},BDT_{{comb}}) > ({bdt_cuts[i]},{bdt_cuts[i]})", "fp")
        if(i == 0):
    ...
    for i in range(N):
        ...
        histos_bdt1_ws_data[i].GetYaxis().SetTitle("Normalized entries / (40 MeV)")
        histos_bdt1_ws_data[i].SetTitle("WS data: B mass vs physics BDT")
        leg14_bdt1.AddEntry(histos_bdt1_ws_data[i], f"BDT_{{phys}} > {bdt_cuts[i]}", "fp")
        if(i == 0):
    ...
    for i in range(N):
        ...
        histos_bdt2_ws_data[i].GetYaxis().SetTitle("Normalized entries / (40 MeV)")
        histos_bdt2_ws_data[i].SetTitle("WS data: B mass vs combinatorial BDT")
        leg14_bdt2.AddEntry(histos_bdt2_ws_data[i], f"BDT_{{comb}} > {bdt_cuts[i]}", "fp")
        if(i == 0):
    ...
    # Physics BDT
    h_norm_mc_phys = ROOT.TH1D("h_norm_mc_phys", "h_norm_mc_phys", 30, 0, 1)
    t_norm_mc_no_rect_cuts_2016.Draw("BDT1 >> h_norm_mc_phys", "(Bp_dtf_M[0] > 5235) && (Bp_dtf_M[0] < 5355)")

    h_norm_data_phys = ROOT.TH1D("h_norm_data_phys", "h_norm_data_phys", 30, 0, 1)
    t_norm_data_no_rect_cuts_2016.Draw("BDT1 >> h_norm_data_phys", "(Bp_dtf_M[0] > 5320)")

    c15 = ROOT.TCanvas()
    c15.cd()
    h_norm_data_phys.GetXaxis().SetTitle("BDT1")
    h_norm_data_phys.GetYaxis().SetTitle("Normalized entries / (0.03)")
    h_norm_data_phys.SetTitle("Physics BDT")
    h_norm_data_phys.SetLineColor(2)
    h_norm_mc_phys.SetLineColor(4)
    h_norm_data_phys.DrawNormalized("hist")
    h_norm_mc_phys.DrawNormalized("same")
    phys_leg_4 = ROOT.TLegend(0.4, 0.8, 0.7, 0.89)
    phys_leg_4.AddEntry(h_norm_mc_phys, "Signal", "lp")
    phys_leg_4.AddEntry(h_norm_data_phys, "Background", "lp")
    phys_leg_4.SetBorderSize(0)
    phys_leg_4.SetBorderSize(0)
    phys_leg_4.Draw("same")
    c15.SaveAs(f"/panfs/felician/B2Ktautau/workflow/sklearn_plots/phys_sig_vs_bkg_norm.pdf")

    # Combinatorial BDT
    h_norm_mc_comb = ROOT.TH1D("h_norm_mc_comb", "h_norm_mc_comb", 30, 0, 1)
    t_norm_mc_no_rect_cuts_2016.Draw("BDT2 >> h_norm_mc_comb", "(Bp_dtf_M[0] > 5235) && (Bp_dtf_M[0] < 5355)")

    h_norm_data_comb = ROOT.TH1D("h_norm_data_comb", "h_norm_data_comb", 30, 0, 1)
    t_norm_data_no_rect_cuts_2016.Draw("BDT2 >> h_norm_data_comb", "(Bp_dtf_M[0] > 5320)")

    c16 = ROOT.TCanvas()
    c16.cd()
    h_norm_data_comb.GetXaxis().SetTitle("BDT2")
    h_norm_data_comb.GetYaxis().SetTitle("Normalized entries / (0.03)")
    h_norm_data_comb.SetTitle("Combinatorial BDT")
    h_norm_data_comb.SetLineColor(2)
    h_norm_mc_comb.SetLineColor(4)
    h_norm_data_comb.DrawNormalized("hist")
    h_norm_mc_comb.DrawNormalized("same")
    comb_leg_4 = ROOT.TLegend(0.4, 0.8, 0.7, 0.89)
    comb_leg_4.AddEntry(h_norm_mc_comb, "Signal", "lp")
    comb_leg_4.AddEntry(h_norm_data_comb, "Background", "lp")
    comb_leg_4.SetBorderSize(0)
    comb_leg_4.SetBorderSize(0)
    comb_leg_4.Draw("same")
    c16.SaveAs(f"/panfs/felician/B2Ktautau/workflow/sklearn_plots/comb_sig_vs_bkg_norm.pdf")
    ...
    c17.cd()
    c17.SetLogz()
    h_bdt1_bdt2_norm_mc.GetXaxis().SetTitle("Combinatorial (BDT2)")
    h_bdt1_bdt2_norm_mc.GetYaxis().SetTitle("Physics (BDT1)")
    h_bdt1_bdt2_norm_mc.SetTitle(f"Norm MC: physics vs combinatorial BDT (#rho = {h_bdt1_bdt2_norm_mc.GetCorrelationFactor():.2f})")
    ...
    c18.cd()
    c18.SetLogz()
    h_bdt1_bdt2_norm_data.GetXaxis().SetTitle("Combinatorial (BDT2)")
    h_bdt1_bdt2_norm_data.GetYaxis().SetTitle("Physics (BDT1)")
    h_bdt1_bdt2_norm_data.SetTitle(f"Norm data: physics vs combinatorial BDT (#rho = {h_bdt1_bdt2_norm_data.GetCorrelationFactor():.2f})")
