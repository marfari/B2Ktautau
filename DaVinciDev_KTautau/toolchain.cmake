...
if(NOT CMAKE_SOURCE_DIR MATCHES "CMakeTmp")
  find_path(gaudi_cmake_modules NAMES GaudiToolchainMacros.cmake
            HINTS /cvmfs/lhcb.cern.ch/lib/var/lib/LbEnv/2399/stable/linux-64/lib/python3.9/site-packages/LbDevTools/data/cmake)
  ...
  if(first_used_project STREQUAL "GAUDI" 
    ...
    include(/cvmfs/lhcb.cern.ch/lib/var/lib/LbEnv/2399/stable/linux-64/lib/python3.9/site-packages/LbDevTools/data/toolchain.cmake)
  else()
    ...
    set(ENV{LBUTILSROOT} /cvmfs/lhcb.cern.ch/lib/var/lib/LbEnv/2399/stable/linux-64/lib/python3.9/site-packages/LbDevTools/data/..)
